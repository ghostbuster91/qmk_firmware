...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   [_FUN] = LAYOUT_split_3x6_3(
        ...
        //,-----------------------------------------------------.                    ,-----------------------------------------------------.
	QK_BOOT     ,KC_COLEMAK  ,KC_NRST   ,_______   ,_______   ,_______                ,_______ ,KC_F7  ,KC_F8   ,KC_F9   ,KC_F12, KC_F15,
        //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
	_______      ,O_GUI    ,O_LALT   ,O_SFT    ,O_CTL    ,O_RALT	       	       ,_______ ,KC_F4  ,KC_F5   ,KC_F6   ,KC_F11, KC_F14,
        //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
